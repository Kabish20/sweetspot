...
if page == "Home":
    ...
    st.image("https://via.placeholder.com/800x300", caption="Delicious Cakes Awaiting You", use_column_width=True)  # Replace with your logo or an image
    st.write("At SweetSpot, we offer a wide variety of custom cakes for every occasion. Explore our collection and find the perfect cake for your next event!")

    # You can add more sections or features here
    st.write("#### Features:")
    st.write("- **Customizable Cakes**: Choose your flavor, size, and decorations.")
    st.write("- **Fast Delivery**: We ensure timely delivery to your doorstep.")
    st.write("- **Customer Support**: Our team is here to assist you 24/7.")
